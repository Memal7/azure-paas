...
public class App {
  ...
  public void downloadToFile() {
    ...
    // BEGIN:
    // com.azure.storage.blob.BlobClient.downloadToFileWithResponse#String-BlobRange-ParallelTransferOptions-DownloadRetryOptions-BlobRequestConditions-boolean-Duration-Context
  ...
  /**
   * Code snippets for
   * {@link BlobClient#abortCopyFromUrlWithResponse(String, String, Duration, Context)}
   */
  public void abortCopyFromUrlWithResponseCodeSnippets() {

    // BEGIN:
    // com.azure.storage.blob.BlobClient.abortCopyFromUrlWithResponse#String-String-Duration-Context
  ...
  /**
   * Code snippets for
   * {@link BlobClient#copyFromUrlWithResponse(String, Map, AccessTier, RequestConditions,
   * BlobRequestConditions, Duration, Context)}
   */
  public void copyFromUrlWithResponseCodeSnippets() {

    // BEGIN:
    // com.azure.storage.blob.BlobClient.copyFromUrlWithResponse#String-Metadata-AccessTier-RequestConditions-BlobRequestConditions-Duration-Context
  ...
  /**
   * Code snippets for
   * {@link BlobClient#downloadWithResponse(OutputStream, BlobRange, DownloadRetryOptions,
  ...
  public void downloadWithResponseCodeSnippets() {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.downloadWithResponse#OutputStream-BlobRange-DownloadRetryOptions-BlobRequestConditions-boolean-Duration-Context
    BlobRange range = new BlobRange(1024, 2048L);
    DownloadRetryOptions options = new DownloadRetryOptions().setMaxRetryRequests(5);
  ...
  /**
   * Code snippets for
   * {@link BlobClient#deleteWithResponse(DeleteSnapshotsOptionType, BlobRequestConditions, Duration,
   * Context)}
   */
  public void deleteWithResponseCodeSnippets() {

    // BEGIN:
    // com.azure.storage.blob.BlobClient.deleteWithResponse#DeleteSnapshotsOptionType-BlobRequestConditions-Duration-Context
  ...
  /**
   * Code snippets for
   * {@link BlobClient#getPropertiesWithResponse(BlobRequestConditions, Duration, Context)}
   */
  public void getPropertiesWithResponseCodeSnippets() {

    // BEGIN:
    // com.azure.storage.blob.BlobClient.getPropertiesWithResponse#BlobRequestConditions-Duration-Context
  ...
  /**
   * Code snippets for
   * {@link BlobClient#setHttpHeadersWithResponse(BlobHttpHeaders, BlobRequestConditions, Duration,
   * Context)}
   */
  public void setHTTPHeadersWithResponseCodeSnippets() {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.setHTTPHeadersWithResponse#BlobHttpHeaders-BlobRequestConditions-Duration-Context
    BlobRequestConditions requestConditions = new BlobRequestConditions().setLeaseId(leaseId);
  ...
  /**
   * Code snippets for
   * {@link BlobClient#setMetadataWithResponse(Map, BlobRequestConditions, Duration, Context)}
   */
  public void setMetadataWithResponseCodeSnippets() {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.setMetadataWithResponse#Metadata-BlobRequestConditions-Duration-Context
    BlobRequestConditions requestConditions = new BlobRequestConditions().setLeaseId(leaseId);
  ...
  /**
   * Code snippets for
   * {@link BlobClient#createSnapshotWithResponse(Map, BlobRequestConditions, Duration,
   * Context)}
   */
  public void createSnapshotWithResponseCodeSnippets() {

    // BEGIN:
    // com.azure.storage.blob.BlobClient.createSnapshotWithResponse#Metadata-BlobRequestConditions-Duration-Context
  ...
  /**
   * Code snippets for
   * {@link BlobClientBase#setAccessTierWithResponse(AccessTier, RehydratePriority, String, Duration, Context)}
   */
  public void setTierWithResponseCodeSnippets() {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.setTierWithResponse#AccessTier-RehydratePriority-String-Duration-Context
  ...
  public void undeleteWithResponseCodeSnippets() {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.undeleteWithResponse#Duration-Context
  ...
  /**
   * Code snippet for
   * {@link BlobClient#getAccountInfoWithResponse(Duration, Context)}
   */
  public void getAccountInfoWithResponseCodeSnippets() {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.getAccountInfoWithResponse#Duration-Context
  ...
  /**
   * Code snippet for {@link BlobClient#upload(String)}
   *
  ...
  public void uploadInputStream() throws IOException {
    ...
    try {
      ...
      client.upload(dataStream, data.length());
      dataStream.close();
  ...
  /**
   * Code snippet for
   * {@link BlobClient#uploadFromFile(String, ParallelTransferOptions, BlobHttpHeaders, Map, AccessTier, BlobRequestConditions, Duration)}
   *
   * @throws IOException If an I/O error occurs
   */
  public void uploadFromFile2() throws IOException {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.uploadFromFile#String-ParallelTransferOptions-BlobHttpHeaders-Map-AccessTier-BlobRequestConditions-Duration
  ...
  public void uploadFromFile3() throws IOException {
    // BEGIN:
    // com.azure.storage.blob.BlobClient.uploadFromFileWithResponse#BlobUploadFromFileOptions-Duration-Context
    BlobHttpHeaders headers = new BlobHttpHeaders()
        .setContentMd5("data".getBytes(StandardCharsets.UTF_8))
        .setContentLanguage("en-US")
        .setContentType("binary");
